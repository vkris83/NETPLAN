...
void ReadParameters(const char* fileinput) {
	...
	if ( file != NULL ) {
		for (;;) {
			...
			if ( line[0] != '$' && line[0] != '/' && line[0] != '#' && line[0] != '%' ) {
				...
				else if (prop == "Wbase") Wbase = atof(value.c_str()); // May 30 2011 // INV Venkat
				else if (prop == "Lbase") Lbase = atof(value.c_str());
				else if (prop == "Peak1") Peak1 = atof(value.c_str()); // July 03 2011 // INV Venkat
				else if (prop == "Peak10") Peak10 = atof(value.c_str());
				else if (prop == "Peak30") Peak30 = atof(value.c_str());
				else if (prop == "Peak60") Peak60 = atof(value.c_str());
				else if (prop == "CycleReg") CycleReg = atof(value.c_str()); // Aug 10 2011 // cycle Venkat
				else if (prop == "CycleCO2") CycleCO2 = atof(value.c_str());
				else if (prop == "CycleSO2") CycleSO2 = atof(value.c_str());
				else if (prop == "CycleNOx") CycleNOx = atof(value.c_str());
	...
	// May 18 Venkat Krishnan
	NodeProp.push_back("ContingencyReserve"); NodeDefault.push_back("X");
	// May 27 Venkat Krishnan
	NodeProp.push_back("Regulation"); NodeDefault.push_back("X"); // INV Venkat
	NodeProp.push_back("Ramp10"); NodeDefault.push_back("X"); // INV June 28 Venkat
	NodeProp.push_back("Ramp30"); NodeDefault.push_back("X"); // INV
	NodeProp.push_back("Ramp60"); NodeDefault.push_back("X"); // INV
	...
	// May 18 Venkat Krishnan
	ArcProp.push_back("RampRate"); ArcDefault.push_back("0"); // INV
	// July 28 Venkat Krishnan
	ArcProp.push_back("Wbase"); ArcDefault.push_back("2.2"); // INV
	// May 27 Venkat Krishnan
	ArcProp.push_back("pRegulation"); ArcDefault.push_back("0"); // May 28 // INV Venkat
	ArcProp.push_back("pRamp10"); ArcDefault.push_back("0"); // June 28 // INV
	ArcProp.push_back("pRamp30"); ArcDefault.push_back("0"); // June 28 // INV
	ArcProp.push_back("pRamp60"); ArcDefault.push_back("0"); // June 28 // INV

	ArcProp.push_back("Cycles"); ArcDefault.push_back("0"); // Aug 10 // cycle
	ArcProp.push_back("CyclesCost"); ArcDefault.push_back("0"); // Aug 10 // cycle

	ArcProp.push_back("FOR"); ArcDefault.push_back("0"); // June 05 2012 // CR op. - FOR parameters
	ArcProp.push_back("AvgGWFOR"); ArcDefault.push_back("0"); // June 05 2012 // CR op. - FOR parameters
	ArcProp.push_back("BaseGWhFOR"); ArcDefault.push_back("1"); // June 05 2012 // CR op. - FOR parameters
	
	ArcProp.push_back("HRDreg"); ArcDefault.push_back("0"); // June 07 2012 // Heat rate degradation Reg
	ArcProp.push_back("HRDsr"); ArcDefault.push_back("0"); // June 07 2012 // Heat rate degradation SR
	ArcProp.push_back("VOCreg"); ArcDefault.push_back("0"); // June 07 2012 // VOC Reg
	ArcProp.push_back("VOCsr"); ArcDefault.push_back("0"); // June 07 2012 // VOC SR
