...
int main (int argc, char **argv) {
	...
	nsga2a->evaluatePop(nsga2a->parent_pop, events);								// JINXU: This is to be performed in parallel
	...
	nsga2b->evaluatePop(nsga2b->parent_pop, events);								// JINXU: This is to be performed in parallel
	...
	for ( int i = 2; i <= nsga2a->ngen; i++ ) {
		...
		nsga2a->evaluatePop(nsga2a->child_pop, events);								// JINXU: This is to be performed in parallel
		...
		nsga2b->evaluatePop(nsga2b->child_pop, events);								// JINXU: This is to be performed in parallel
