...
string SName;
Step SLength;
bool useDCflow = false, useBenders = false, reportSolution = false;
...
double Np_start = 0.5, ELReg = 0, ELReg10 = 0, ELReg30 = 0, ELReg60 = 0, Wbase = 2.2, Lbase = 6.25, Peak1 = 30, Peak10 = 20, Peak30 = 10, Peak60 = 6, CycleReg=0, CycleCO2=0, CycleSO2=0, CycleNOx=0; // May 30 2011 - regulation variables; INV
vector<string> ArcProp(0), ArcDefault(0), NodeProp(0), NodeDefault(0), TransInfra(0), TransComm(0), StepHours(0), SustObj(0), SustMet(0), Regnode(0), Regnode10(0), Regnode30(0), Regnode60(0); // May 28 INV
int NodePropOffset = 0, ArcPropOffset = 0, outputLevel = 2;
vector<double> Regvalue(0), Regvalue10(0), Regvalue30(0), Regvalue60(0), FinalObjectives(0); // May 28 Regulation VK INV // June 05 2012 - Final obj. write in file

// Store indices to recover data after optimization
Index IdxNode, IdxUd, IdxRm, IdxArc, IdxInv, IdxCap, IdxUb, IdxEm, IdxDc, IdxRmrc, IdxRmrp10, IdxRC10, IdxRC30, IdxRmrp30, IdxRmrp60, IdxRC60, IdxCR, IdxCRop, IdxRU, IdxRD; //, IdxSR,IdxRR, IdxCyE, IdxCyCR, IdxCyRU, IdxCyRD, IdxCySR, IdxCyRR; // May 23 2011 VK - Comntingency Reserve; May 27 - Regulation INV // cycling AUg 11 // June 05 2012 - CRop
