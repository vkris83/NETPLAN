...
void ReadParameters(const char* fileinput) {
	...
	if (file != NULL) {
		for (;;) {
			...
			if ((line[0] != '$') && (line[0] != '/') && (line[0] != '#') && (line[0] != '%')) {
				...
				else if (prop == "UseEndSalvg") useEndSalvg = (value == "true" || value == "True" || value == "TRUE"); // Venkat End effect Apr 12 2013
				else if (prop == "UseEndPrimE") useEndPrimE = (value == "true" || value == "True" || value == "TRUE"); // Venkat End effect Apr 12 2013
				else if (prop == "UseEndDualE") useEndDualE = (value == "true" || value == "True" || value == "TRUE"); // Venkat End effect Apr 12 2013
				else if (prop == "UseEndFixed") useEndFixed = (value == "true" || value == "True" || value == "TRUE"); // Venkat End effect Apr 12 2013
				else if (prop == "SLengthend") SLengthend = atoi(value.c_str()); // Venkat End effect Apr 12 2013
				else if (prop == "Loadgrowth") Loadgrowth = atof(value.c_str()); // Venkat End effect Apr 12 2013
				else if (prop == "CapRed") CapRed = atof(value.c_str()); // Venkat End effect Apr 12 2013
				else if (prop == "Sobjeval") Sobjeval = atof(value.c_str()); // Venkat End effect May 3 2013
	...
	if (useEndDualE || useEndPrimE) // Venkat End effect - Dual Eq. April 17 2013
	{		
		SLength[0]=SLength[0]+1; // add extra time period for end effects calculation (stationary time)
	}

	if (useEndFixed)
		SLength[0]=SLength[0] + SLengthend;
